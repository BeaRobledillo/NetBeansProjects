...
public class ProductoVista {
    ...
    /*declaramos metodo q muestre los datos de un producto*/
    ...
    public int buscarProducto() {
        Scanner entrada = new Scanner(System.in);
        System.out.println("Introduza el id del producto a buscar:");
        int idProducto = entrada.nextInt();
    ...
    public Producto modirficarProducto(Producto productoActual) {
        Scanner entrada = new Scanner(System.in);
