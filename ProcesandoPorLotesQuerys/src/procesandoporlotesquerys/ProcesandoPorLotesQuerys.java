...
public class ProcesandoPorLotesQuerys {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //String query2 = "UPDATE cliente SET nombre = 'Ataulfoo', direccion = 'Calle Alcala 232, Madrid', telefono = '123456789', persona = 'Persona de Contacto' WHERE cliente.idCliente = 2";
           //String query3 = "DELETE FROM cliente WHERE cliente.idCliente = 8";
